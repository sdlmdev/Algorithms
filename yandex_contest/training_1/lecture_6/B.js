...
// а в третьей строке – K чисел второго массива. Каждое число в обоих массивах по модулю не превосходит 2⋅109.
...
const res = nums.map(num => binarySearch(0, arr.length - 1, arr, num));
