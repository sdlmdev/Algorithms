...
// Когда за студентом наблюдает хотя бы один преподаватель,
// он стесняется и не идет искать ответы к экзамену.
...
// Формат ввода
// В первой строке находятся два целых числа 1 ≤ N ≤ 10**9, 1 ≤ M ≤ 10**4 — число студентов
